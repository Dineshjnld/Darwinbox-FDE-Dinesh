...
The demo shows the complete migration workflow, including:

- Multi-file CSV/XLSX ingestion
- AI-assisted mapping and reconciliation
- Validation and confidence-based decisions
- Human-in-the-loop escalation
- Escalation resolution through the UI
- Migration resume after approval
- Target execution
- Failure and retry
- Audit trail

<video src="https://github.com/user-attachments/assets/1d83aba7-b96e-47fa-ae13-4720d0e37fa5"
       controls
       autoplay
       muted
       playsinline
